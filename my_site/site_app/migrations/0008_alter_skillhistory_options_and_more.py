# Generated by Django 4.0.4 on 2022-07-03 18:15
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('site_app', '0007_rename_stages_skillhistory_stage_remove_skills_stage_and_more'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='skillhistory',
            options={'ordering': ['-date_over'], 'verbose_name': 'Стадія розвитку вміння', 'verbose_name_plural': 'Стадії розвитку вмінь'},
        ),
